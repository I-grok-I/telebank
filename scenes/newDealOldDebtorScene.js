...
const newDealOldDebtorScene = new Scenes.WizardScene('newDealOldDebtorScene', start, productName, cost, period, margin, guarantorStep, photoStep, checkInfoStep, updateDb)
